...
function actualizarCV() {
  ...
  // NOTA: se añade id="cvPhoto" a la imagen para que el resto del script
  // (subida, borrado y carga de foto) pueda encontrarla sin errores.
  const fotoHTML = photoData ?
    `<img id="cvPhoto" class="cv-photo" src="${photoData}" alt="Foto" style="display:block;" />` :
    `<img id="cvPhoto" class="cv-photo" src="" alt="Foto" style="display:none;" />`;
